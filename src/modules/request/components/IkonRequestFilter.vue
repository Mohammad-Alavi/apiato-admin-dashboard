<template>
  <v-dialog v-model="dialog" max-width="500px">
    ...
    <v-card tile>
      ...
      <ikon-request-filter-filters :key="filterComponentKey" :filter.sync="filter" class="pb-16"/>
...
export default {
  name: 'IkonRequestFilter',
  extends: IkonFilter,
  components: {
    IkonRequestFilterFilters: () => import('@/modules/users/components/IkonRequestFilterFilters')
  }
}
</script>
