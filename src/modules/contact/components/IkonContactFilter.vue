<template>
  <v-dialog v-model="dialog" max-width="500px">
    ...
    <v-card tile>
      ...
      <ikon-contact-filter-filters :key="filterComponentKey" :filter.sync="filter" class="pb-16"/>
...
export default {
  name: 'IkonContactFilter',
  extends: IkonFilter,
  components: {
    IkonContactFilterFilters: () => import('@/modules/contact/components/IkonContactFilterFilters')
  }
}
</script>
