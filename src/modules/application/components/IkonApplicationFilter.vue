<template>
  <v-dialog v-model="dialog" max-width="500px">
    ...
    <v-card tile>
      ...
      <ikon-application-filter-filters :key="filterComponentKey" :filter.sync="filter" class="pb-16"/>
...
export default {
  name: 'IkonApplicationFilter',
  extends: IkonFilter,
  components: {
    IkonApplicationFilterFilters: () => import('@/modules/application/components/IkonApplicationFilterFilters')
  }
}
</script>
