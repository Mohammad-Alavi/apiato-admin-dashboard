<template>
  <v-dialog v-model="dialog" max-width="500px">
    ...
    <v-card tile>
      ...
      <ikon-user-filter-filters :key="filterComponentKey" :filter.sync="filter" class="pb-16"/>
...
export default {
  ...
  extends: IkonFilter,
  components: {
    IkonUserFilterFilters: () => import('@/modules/users/components/IkonUserFilterFilters')
  }
}
</script>
