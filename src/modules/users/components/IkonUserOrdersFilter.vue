<template>
  <v-dialog v-model="dialog" max-width="500px">
    ...
    <v-card tile>
      ...
      <ikon-user-orders-filter-filters :key="filterComponentKey" :filter.sync="filter" class="pb-16"/>
...
export default {
  name: 'IkonUserOrdersFilter',
  extends: IkonFilter,
  components: {
    IkonUserOrdersFilterFilters: () => import('@/modules/users/components/IkonUserOrdersFilterFilters')
  }
}
</script>
