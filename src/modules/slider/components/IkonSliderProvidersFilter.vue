<template>
  <v-dialog v-model="dialog" max-width="500px">
    ...
    <v-card tile>
      ...
      <ikon-slider-providers-filter-filters :key="filterComponentKey" :filter.sync="filter" class="pb-16"/>
...
export default {
  name: 'IkonSliderProvidersFilter',
  extends: IkonFilter,
  components: {
    IkonSliderProvidersFilterFilters: () => import('./IkonSliderProvidersFilterFilters')
  }
}
</script>
